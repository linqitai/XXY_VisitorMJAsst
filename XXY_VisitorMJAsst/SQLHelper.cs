�鲄鲑鳃鳜鳣雭雺隹雚雟颩鞈鞘鞕鞙鞞鞝鞢鞰骳骹髉韎韘馧髲髺馮馱馲駃駄馸馶駘麃麇麆鳥鳭鳱鳻鳺鳽鶗鶡鶻鶝鶣鶙鶨鶬鶽鮭鮆鮥鯆鯣黮黰黵龏颌颉羏袌袲羬羙坋尅朌橨炃瓲瘧羛羫重解系被率石省期查术见给红提属她家合广强大说识许参单信便传会丛区些厂其且不万了么羊颈颤食趣趋辟臭裳繁粥蛾蛇疑疆番畜罢盖盛铅秘朝曾恶氏暴景棍校枝柜朱炮扁戏旁殖孙愉圈填塞堡巷缴纤港渠涌洒泽泄浅泊沈汤摄揭括拘拌折抢扛扒壳尾尿崭岂姥女宿喝咳否吓召叶句叨弄校棍景暴氏恶曾朝秘铅盖罢畜番疆疑蛇蛾粥繁裳臭辟趋趣食颤颈羊乾冯刨刹剿兑凹伺佃侥俏傀卒芥苛尉夯契幢吁吭呐呵咖唬喳嘲嘿宛嵌彭屏拗拂拓挟掺掸揣撮攒泌涡淳淌溃澄瀑绰堕囤栅栖椎楷椎稽铛疙磅祭甸蚣蛤疟耙频卝龜丱乁乇乗丂丌乜乚乿屰兌匋凈厈兏厔厱剎剡剢剳剬剹剸劋兊亟匼匨匮區匱邟郇郄郂郦郩隗隋隊隃隑隓隩隳兹卬劦勜勦勭勷冘凵仒仐仧俞仡仛仠伡伎仯仸佁伽佝佚佔佄佋侗佴俟俥侱侸俶倅倞倆俿偲偢側偅偒傕傖傋傔傂僄傳傮傶僝僜僮僥僫僣僪儃儗儴儶兪卛厶厷厸厹亝參叄叅亨亹诒诘诶诪叕叞芐芘芾芴苣馧髲髺馮馱馲駃駄馸馶駘麃麇麆鳥鳭鳱鳻鳺鳽鶗鶡鶻鶝鶣鶙鶨鶬鶽鮭鮆鮥鯆鯣黮黰黵龏颌颉羏袌袲羬羙坋朌炃瓲瘧羛羫";
        ...
        #region//判断数据库是否已连接   是:true  否:false
              ...
              string para_strFlag, string para_strByInternet)
        {
            ...
            connectionString_1 = connectionString;
            return bSFLJ;
        ...
        public void ExecuteSql(string DatabaseName, string Sql, string strConnectionString)
        {
...
#region
    ...
    new string[]{"zuo","做作坐左座昨凿琢撮佐笮酢唑祚胙怍阼柞乍侳咗岝岞挫捽柮椊砟秨稓筰糳繓苲莋葃葄蓙袏諎醋鈼鑿飵嘬阝"}
        ...
        #region//定义民族
        public static readonly string[][] _Nation = new string[][]
         {
        ...
        public bool CheckFromInput(string str_char)
        {
            ...
            else if (str_char.ToLower().IndexOf(@"delete") >= 0)
            {
                return false;
            }
            else if (str_char.ToLower().IndexOf(@"and") >= 0)
            {
                return false;
            }
            else if (str_char.ToLower().IndexOf(@"update") >= 0)
            {
                return false;
            }
            else if (str_char.ToLower().IndexOf(@"insert") >= 0)
            {
                return false;
            }
            else if (str_char.ToLower().IndexOf(@"master") >= 0)
            {
                return false;
            }
            else if (str_char.ToLower().IndexOf(@"mid") >= 0)
            {
                return false;
            }
            else if (str_char.ToLower().IndexOf(@"user") >= 0)
            {
                return false;
            }
            else if (str_char.ToLower().IndexOf(@"db_name") >= 0)
            {
                return false;
            }
            else if (str_char.ToLower().IndexOf(@"backup") >= 0)
            {
                return false;
            }
            else if (str_char.ToLower().IndexOf(@"select") >= 0)
            {
                return false;
            }
            else if (str_char.ToLower().IndexOf(@"char") >= 0)
            {
                return false;
            }
            else if (str_char.ToLower().IndexOf(@"nchar") >= 0)
            {
                return false;
            }
            else if (str_char.ToLower().IndexOf(@"xp_cmdshell") >= 0)
            {
                return false;
            }
            else if (str_char.ToLower().IndexOf(@"exec") >= 0)
            {
                return false;
            }
            else if (str_char.ToLower().IndexOf(@"from") >= 0)
            {
                return false;
            }
            else if (str_char.ToLower().IndexOf(@"update") >= 0)
            ...
            else if (str_char.ToLower().IndexOf(@"count") >= 0)
            {
                return false;
            }
            else
        ...
        public static int ExecuteSqlAndImg3(string para_strSQL, byte[] para_fs1 )
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                SqlCommand cmd = new SqlCommand(para_strSQL, connection);
                if (para_fs1 != null)
                {
                    System.Data.SqlClient.SqlParameter myParameter1 = new System.Data.SqlClient.SqlParameter("@VImage", System.Data.SqlDbType.Binary, para_fs1.Length, ParameterDirection.Input, false, 0, 0, null, DataRowVersion.Current, para_fs1);
                    cmd.Parameters.Add(myParameter1);

                    ////System.Data.SqlClient.SqlParameter myParameter1 = new System.Data.SqlClient.SqlParameter("@para_fs1", System.Data.SqlDbType.Binary);
                    ////myParameter1.Value = para_fs1;
                    ////cmd.Parameters.Add(myParameter1);

                    //SqlParameter par = new SqlParameter("@fa", SqlDbType.Image);
                    //par.Value = para_fs1;
                ...
                //if (para_fs2 != null)
                //{
                //    System.Data.SqlClient.SqlParameter myParameter2 = new System.Data.SqlClient.SqlParameter("@VIdImage", System.Data.SqlDbType.Binary, para_fs2.Length, ParameterDirection.Input, false, 0, 0, null, DataRowVersion.Current, para_fs2);
                //    cmd.Parameters.Add(myParameter2);

                //    ////System.Data.SqlClient.SqlParameter myParameter2 = new System.Data.SqlClient.SqlParameter("@para_fs2", System.Data.SqlDbType.Binary);
                //    ////myParameter2.Value = para_fs2;
                //    //////cmd.Parameters.Add(myParameter2);
                //    //SqlParameter par2 = new SqlParameter("@fb", SqlDbType.Image);
                //    //par2.Value = para_fs2;
                //    //cmd.Parameters.Add(par2);
                //}
                //if (para_fs3 != null)
                //{
                //    System.Data.SqlClient.SqlParameter myParameter3 = new System.Data.SqlClient.SqlParameter("@VIdHeaderImage", System.Data.SqlDbType.Binary, para_fs3.Length, ParameterDirection.Input, false, 0, 0, null, DataRowVersion.Current, para_fs3);
                //    cmd.Parameters.Add(myParameter3);

                //    //SqlParameter par3 = new SqlParameter("@fc", SqlDbType.Image);
                //    //par3.Value = para_fs3;
                //    //cmd.Parameters.Add(par3);

                //    //System.Data.SqlClient.SqlParameter myParameter3 = new System.Data.SqlClient.SqlParameter("@para_fs3", System.Data.SqlDbType.Binary);
                //    //myParameter3.Value = para_fs3;
                //    //cmd.Parameters.Add(myParameter3);
                //}
